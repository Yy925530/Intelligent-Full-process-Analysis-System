...
import platform
from matplotlib.font_manager import FontProperties
# 适配Windows/云端Linux双环境
if platform.system() == "Linux":
    plt.rcParams['font.sans-serif'] = ["WenQuanYi Zen Hei", "Noto Sans CJK SC"]
else:
    plt.rcParams['font.sans-serif'] = ["SimHei", "Microsoft YaHei"]
plt.rcParams["axes.unicode_minus"] = False
cn_font = FontProperties(family=plt.rcParams['font.sans-serif'][0])
# ================================================
...
with col1:
    if "价格" in df_clean.columns and not df_clean["价格"].dropna().empty:
        ...
        ax.set_title("价格分布直方图", fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("价格（元）", fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("频数", fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
with col2:
    if "销量" in df_clean.columns and not df_clean["销量"].dropna().empty:
        ...
        ax.set_title("销量分布直方图", fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("销量", fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("频数", fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if region_col:
    ...
    with col1:
        if not region_sales.empty:
            ...
            ax.set_title("各地区销售额对比（前10）", fontsize=10,fontproperties=cn_font)
            ax.set_xlabel("地区", fontsize=8,fontproperties=cn_font)
            ax.set_ylabel("销售额（元）", fontsize=8,fontproperties=cn_font)
            plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
            plt.tight_layout(pad=0.3)
            st.pyplot(fig, use_container_width=False)
...
if product_col:
    ...
    if not product_sales.empty:
        ...
        ax.set_title("产品销售额Top10",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("产品",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
        plt.xticks(rotation=45, ha="right",fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
    ...
    with col1:
        if category_col:
            ...
            if not category_sales.empty:
                ...
                ax.set_title("各产品类别销售额占比",fontsize=10,fontproperties=cn_font)
                ax.set_ylabel("")
                plt.tight_layout(pad=0.3)
                st.pyplot(fig, use_container_width=False)
    ...
    with col2:
        if gender_col:
            ...
            if not gender_sales.empty:
                ...
                ax.set_title("不同性别消费占比",fontsize=10,fontproperties=cn_font)
                ax.set_ylabel("")
                plt.tight_layout(pad=0.3)
                st.pyplot(fig, use_container_width=False)
...
if product_col:
    ...
    if is_moon or is_choco:
        ...
        if not flavor_sales.empty:
            ...
            ax.set_title("各口味/类型销售额排名",fontsize=10,fontproperties=cn_font)
            ax.set_xlabel("口味/类型",fontsize=8,fontproperties=cn_font)
            ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
            plt.xticks(rotation=75, ha="right", fontsize=8,fontproperties=cn_font)
            plt.tight_layout(pad=0.3)
            st.pyplot(fig, use_container_width=False)
...
if age_col:
    ...
    if not df_age_valid.empty:
        ...
        ax.set_title("各年龄层销售额对比",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("年龄分组",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
        plt.xticks(fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if salesperson_col:
    ...
    if not salesperson_sales.empty:
        ...
        ax.set_title("销售人员业绩Top10",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("销售人员",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
        plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if channel_col:
    ...
    if not channel_sales.empty:
        ...
        ax.set_title("各销售渠道销售额对比",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("销售渠道",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
        plt.xticks(fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
    ...
    with col1:
        if pay_col:
            ...
            if not pay_sales.empty:
                ...
                ax.set_title("各支付方式销售额占比",fontsize=10,fontproperties=cn_font)
    ...
    with col2:
        if customer_type_col:
            ...
            if not customer_sales.empty:
                ...
                ax.set_title("新顾客 vs 老顾客销售额占比",fontsize=10,fontproperties=cn_font)
                ax.set_ylabel("",fontsize=8)
                plt.tight_layout(pad=0.3)
                st.pyplot(fig, use_container_width=False)
...
if len(numeric_cols_for_corr) > 1:
    ...
    ax.set_title("各数值变量相关性热力图", fontsize=9,fontproperties=cn_font)
    # 修复热力图坐标轴中文
    ax.set_xticklabels(corr_matrix.columns,fontproperties=cn_font,fontsize=8)
    ax.set_yticklabels(corr_matrix.index,fontproperties=cn_font,fontsize=8)
    plt.tight_layout(pad=0.3)
    st.pyplot(fig, use_container_width=False)
...
if "价格" in df_clean.columns and "销量" in df_clean.columns:
    ...
    if not df_price_sales.empty:
        ...
        ax.set_title("价格与销量散点图",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("价格（元）",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销量",fontsize=8,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if "折扣" in df_clean.columns:
    ...
    ax.set_title("折扣力度与总销售额关系",fontsize=10,fontproperties=cn_font)
    ax.set_xlabel("折扣",fontsize=8,fontproperties=cn_font)
    ax.set_ylabel("总销售额（元）",fontsize=8,fontproperties=cn_font)
...
if age_col:
    ...
    if not df_age_valid.empty:
        ...
        ax.set_title("各年龄段的平均消费金额",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("年龄段",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("平均销售额（元）",fontsize=8,fontproperties=cn_font)
        ax.set_xticks(range(len(age_amount)))
        ax.set_xticklabels([str(x) for x in age_amount.index], rotation=45, fontsize=7,fontproperties=cn_font)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
''')
            ...
            axes[0].set_title("真实值 vs 预测值", fontsize=9,fontproperties=cn_font)
            axes[0].set_xlabel("真实销售额（元）", fontsize=8,fontproperties=cn_font)
            axes[0].set_ylabel("预测销售额（元）", fontsize=8,fontproperties=cn_font)
            residuals = y_test - best_pred
            axes[1].scatter(best_pred, residuals, alpha=0.6, c='purple')
            axes[1].axhline(y=0, color='r', linestyle='--')
            axes[1].set_title("残差图", fontsize=9,fontproperties=cn_font)
            axes[1].set_xlabel("预测销售额（元）", fontsize=8,fontproperties=cn_font)
            axes[1].set_ylabel("残差", fontsize=8,fontproperties=cn_font)
            plt.tight_layout(pad=0.3)
            st.pyplot(fig, use_container_width=False)
            # 图片解读+决策
            ...
            ax.set_title("变量重要性排序（前10）",fontsize=10,fontproperties=cn_font)
            ax.set_xlabel("特征变量",fontsize=8,fontproperties=cn_font)
            ax.set_ylabel("重要性",fontsize=8,fontproperties=cn_font)
            plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
            plt.tight_layout(pad=0.3)
            st.pyplot(fig, use_container_width=False)
...
if region_col and category_col:
    ...
    if not cross_data.empty and len(cross_data) <= 20:
        ...
        ax.set_title("各地区不同产品类别销售额对比",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("地区",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
        plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
        ax.legend(prop=cn_font,fontsize=7)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if age_col and category_col:
    ...
    if not df_age_valid.empty:
        ...
        if not cross_age.empty:
            ...
            ax.set_title("各年龄层不同产品类别销售额对比",fontsize=10,fontproperties=cn_font)
            ax.set_xlabel("年龄分组",fontsize=8,fontproperties=cn_font)
            ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
            plt.xticks(fontsize=8,fontproperties=cn_font)
            ax.legend(prop=cn_font,fontsize=7)
...
if channel_col and pay_col:
    ...
    if not cross_channel_pay.empty:
        ...
        ax.set_title("各渠道支付方式占比（%）",fontsize=10,fontproperties=cn_font)
        ax.set_xlabel("销售渠道",fontsize=8,fontproperties=cn_font)
        ax.set_ylabel("占比（%）",fontsize=8,fontproperties=cn_font)
        plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
        ax.legend(prop=cn_font,fontsize=7)
        plt.tight_layout(pad=0.3)
        st.pyplot(fig, use_container_width=False)
...
if "价格" in df_clean.columns and "折扣" in df_clean.columns:
    ...
    df_price_valid = df_clean[df_price_valid["价格"].notna() & (df_price_valid["价格"] > 0)].copy()
    if not df_price_valid.empty:
        ...
        if not cross_price.empty:
            ...
            ax.set_title("不同价格区间-折扣力度的销售额对比",fontsize=10,fontproperties=cn_font)
            ax.set_xlabel("价格区间",fontsize=8,fontproperties=cn_font)
            ax.set_ylabel("销售额（元）",fontsize=8,fontproperties=cn_font)
            plt.xticks(rotation=45, ha="right", fontsize=8,fontproperties=cn_font)
            ax.legend(prop=cn_font,fontsize=7)
            plt.tight_layout(pad=0.3)
